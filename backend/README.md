...
## Project Structure
    ...
    ├── tst_fewfqegqerb_dev_67275  # Django project configurations
...
1. Clone this repo and `cd tst_fewfqegqerb_dev_67275`
...
2. Clone this repo and `cd tst_fewfqegqerb_dev_67275`
